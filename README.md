...
- **Settings** — LM Studio endpoints; cloud endpoints via provider presets (OpenAI, Groq, OpenRouter, Together, DeepSeek, Mistral) or any custom OpenAI-compatible base URL; presets, filesystem/shell tools, memory, Firecrawl key, MCP servers
